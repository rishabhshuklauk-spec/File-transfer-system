...
* **File durations:** Choose exactly how long your file survives:        
   Self-Destruct: The file is permanently wiped from the database and storage the split second it is downloaded once.     
   Multi-Download: A Redis-backed counter tracks downloads and triggers an atomic purge when the limit is hit.        
   Timed: Unlimited downloads for 1 day, managed by automated Redis TTL expirations.      
